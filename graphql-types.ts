...
export type SitePageFieldsEnum =
  ...
  | 'pluginCreator___pluginOptions___remarkPlugins___onlyRunWithMarker'
  | 'pluginCreator___pluginOptions___remarkPlugins___pattyName'
...
export type SitePluginFieldsEnum =
  ...
  | 'pluginOptions___remarkPlugins___onlyRunWithMarker'
  | 'pluginOptions___remarkPlugins___pattyName'
...
export type NewsListQuery = { news: { nodes: Array<(
      Pick<Mdx, 'excerpt'>
...
export type PostsQuery = { posts: { nodes: Array<(
...
export type SiteMetaDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'description' | 'siteImage'>> }> };

export type IndexQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexQuery = { mdx?: Maybe<(
    Pick<Mdx, 'excerpt' | 'body'>
...
export type NewsPageQuery = { mdx?: Maybe<(
    Pick<Mdx, 'excerpt' | 'body'>
    & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'description'>> }
  )> };
...
export type BlogPostBySlugQuery = { mdx?: Maybe<(
    Pick<Mdx, 'id' | 'excerpt' | 'body'>
    & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description'>> }
