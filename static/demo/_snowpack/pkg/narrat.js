...
const _hoisted_7$1 = /*#__PURE__*/createTextVNode(" default body ");
...
var script$3 = defineComponent({
    ...
    computed: {
        ...
        skillChecks() {
            return this.$store.state.skillChecks;
        },
    },
});
...
const _hoisted_10 = /*#__PURE__*/createBaseVNode("h2", null, "Skills", -1);
const _hoisted_11 = { class: "table-auto" };
const _hoisted_12 = /*#__PURE__*/createBaseVNode("tr", null, [
  /*#__PURE__*/createBaseVNode("th", null, "Skill"),
  /*#__PURE__*/createBaseVNode("th", null, "Level")
], -1);
const _hoisted_13 = /*#__PURE__*/createBaseVNode("h2", null, "Skill Checks", -1);
...
const _hoisted_15 = /*#__PURE__*/createBaseVNode("thead", null, [
  /*#__PURE__*/createBaseVNode("tr", null, [
    ...
    /*#__PURE__*/createBaseVNode("th", null, "Available"),
            ...
            createBaseVNode("table", _hoisted_11, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.skills, (skill, key) => {
                return (openBlock(), createElementBlock("tr", { key: key }, [
                  ...
                  createBaseVNode("td", null, toDisplayString(skill.level), 1)
                ]))
              }), 128))
            ]),
            _hoisted_13,
            createBaseVNode("table", _hoisted_14, [
              ...
              createBaseVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.skillChecks, (check, key) => {
                  return (openBlock(), createElementBlock("tr", { key: key }, [
                    createBaseVNode("td", null, toDisplayString(key), 1),
                    createBaseVNode("td", null, toDisplayString(check.available ? '✅' : '❌'), 1),
                    createBaseVNode("td", null, toDisplayString(check.passed ? '✅' : '❌'), 1)
                  ]))
                }), 128))
              ])
            ])
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(TransitionGroup, {
    ...
    default: withCtx(() => [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.notifications, (notification, id) => {
        return (openBlock(), createElementBlock("div", {
          class: "notification",
          key: id
        }, [
          createBaseVNode("h2", null, toDisplayString(notification.text), 1)
        ]))
      }), 128))
    ]),
    _: 1
...
var css_248z$7 = ".notifications-holder {\n  position: fixed;\n  bottom: 0;\n  width: 100vw;\n  display: flex;\n  flex-direction: column-reverse;\n  align-items: center;\n}\n\n.notification {\n  margin-top: 20px;\n  margin-bottom: 20px;\n  border-radius: 10px;\n  padding: 20px;\n  background-color: darkslateblue;\n  color: white;\n  width: 50vh;\n  text-align: center;\n}\n";
...
function screenToCanvas(x, y, element) {
...
var script$7 = defineComponent({
    ...
    computed: {
        ...
        screenRatio() {
            const config = getConfig();
            const baseWidth = config.layout.minTextWidth + config.layout.backgrounds.width;
    ...
    methods: {
        ...
        isDialogActive(i) {
            const result = i === this.dialog.length - 1 &&
                this.$store.state.machine.stack.length > 0;
            return result;
        },
        nextLine() {
        ...
        getDialogBoxOptions(dialogKey, index) {
            ...
            if (dialogKey.choices) {
                dialogKey.choices.forEach((choice) => {
                    choice.choice = processText(this.$store, choice.choice);
                });
            }
            return {
                title,
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    (_ctx.options.debug)
      ? (openBlock(), createBlock(_component_DebugMenu, { key: 3 }))
      : createCommentVNode("", true),
...
function setupStore(options) {
    ...
    store = createStore({
        ...
        actions: {
            async startMachine({ commit, dispatch }, payload) {
        ...
        mutations: {
            ...
            addInstruction(state, { path, value }) {
                const dataToModify = getModifiableData(state);
...
async function startApp(config, options) {
    ...
    app.use(store$1, storeSetup.key);
    app.use(N, {
        breakpoints: {
